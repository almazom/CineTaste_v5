#!/usr/bin/env python3
"""
ct-filter/port.py — Validation Port (розетка)

Validates input (analysis-result@1.0.0) and output (filter-result@1.0.0).
...
def enforce_input(data: dict) -> dict:
    """
    Validate input data against analysis-result contract.
...
def enforce_output(data: dict) -> dict:
    """
    Validate output data against filter-result contract.
