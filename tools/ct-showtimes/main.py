#!/usr/bin/env python3
"""
ct-showtimes/main.py — CLI Entry Point
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  ct-showtimes --url https://kinoteatr.ru/film/postoronniy-2/naberezhnie-chelni/
  ct-showtimes --url https://kinoteatr.ru/film/postoronniy-2/naberezhnie-chelni/ --date 2026-03-10
  ct-showtimes --url https://kinoteatr.ru/film/postoronniy-2/naberezhnie-chelni/ --dry-run
""",
    )
    ...
    parser.add_argument("--version", action="version", version=f"ct-showtimes {TOOL_VERSION}")
